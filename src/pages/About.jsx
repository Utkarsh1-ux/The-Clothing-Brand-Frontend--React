    ...
    <div>
      ...
      <div className='flex flex-col md:flex-row text-sm mb-20'>
          <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
            ...
            <p className='text-gray-600 dark:text-gray-300'>We are committed to delivering high-quality, reliable, and secure solutions. Every feature of our platform goes through rigorous testing to ensure performance, accuracy, and user satisfaction. Our quality assurance process focuses on functionality, usability, and security, so you can trust our services with confidence.</p>
          </div>
          <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
            <b>Convenience:</b>
            <p className='text-gray-600 dark:text-gray-300'>Our platform is designed with convenience in mind. Easy navigation, quick access to features, and a user-friendly interface ensure you get things done effortlessly, anytime and anywhere.</p>
          </div>
          <div className='border px-10 md:px-16 py-8 sm:py-20 flex flex-col gap-5'>
            <b>Exceptional Customer Service:</b>
            <p className='text-gray-600 dark:text-gray-300'>We are dedicated to providing exceptional customer service at every step. Our support team is responsive, knowledgeable, and always ready to assist you, ensuring a smooth and satisfying experience.</p>
          </div>
      </div>
      <NewsLetterBox/>
    </div>
